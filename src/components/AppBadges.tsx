...
export function AppBadges({ appStoreUrl, playStoreUrl }: AppBadgesProps) {
  return (
    <div className="flex flex-col sm:flex-row gap-3">
      <a
        ...
        className="card-lift flex-1 flex items-center justify-center gap-3 bg-bg-card border border-border rounded-xl p-4"
      >
